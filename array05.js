...
console.log([].concat.apply([], accounts[0].tags)); // list

console.log(accounts[0].tags.flat()); // list

console.log(accounts[0].tags.flat(2)); // list
...
console.log(accounts[0].tags.includes("consectetur")); // false

console.log(accounts[0].tags.flat().includes("consectetur")); //true
 ...
 */
console.log("==============================");
console.log(accounts.map(({ tags }) => tags.join(","))); //array
console.log(accounts.map(({ tags }) => tags.join(",")).join(",")); //string
...
console.log(accounts.map(({ friends }) => friends.map(({ name }) => name)));
console.log(
...
console.log(
  accounts
    .filter(({ balance, age }) => age <= 30 && balance > 1500)
    .map(({ friends }) => friends)
    .flat()
);
