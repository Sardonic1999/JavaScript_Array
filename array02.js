...
// Get a list of the orders for the customer with the
//ID 234 that have not been delivered.
...
//Create a new property an each order with the total price of items ordered.
